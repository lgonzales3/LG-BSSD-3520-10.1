...
/*
    ...
    X Task 6: Accept input of a country and select the proper option in the select.
...
document.addEventListener("DOMContentLoaded", () => {  
    ...
    document.getElementById('submit').addEventListener('click', () => {
        ...
        let userInput = document.getElementById('name').value; //this should be looked up from submit button and input field in your homework 
